    ...
    <app-layout>
        <div class="w-full  md:flex">
            <div class=" fixed h-screen bg-white w-1/4 pt-3 mr-auto shadow ">
                ...
                <div
                    class=" flex group hover:bg-cool-gray-200 cursor-pointer active:bg-cool-gray-200 mx-2 p-2 rounded"
                >
                    <div
                        class=" rounded-full group-hover:text-white group-hover:bg-indigo-500 w-8 h-8 text-center  "
                    >
                        <i
                            class="fal fa-podcast fa-x mt-2 "
                            aria-hidden="true"
                        ></i>
                    </div>
                    <p class="pl-2 my-auto text-lg capitalize font-bold ">
                        all
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        <i
                            class="fal fa-calendar-day fa-x mt-2"
                            aria-hidden="true"
                        ></i>
                    </div>
                    <p class="pl-2 my-auto text-lg capitalize font-bold ">
            ...
            <div class="w-2/3 ml-auto mt-3 pt-3 rounded-lg  ">
                <div
                    ...
                    <div
                        ...
                        class="target ml-auto my-auto bg-indigo-500 cursor-pointer hover:bg-indigo-400 rounded text-white p-2 "
                    >
                        <div class=" font-semibold flex">
                            <i
                                class="fal fa-check my-auto mr-1"
                                aria-hidden="true"
                            ></i>
                            <p>friends</p>
                        </div>
                        <!--friendship option -->
                        <div
                            class=" border border-grey-100 mt-2 px-3 p-2 capitalize text-gray-800  dropdown-menu hidden absolute bg-white rounded "
                        >
                            <div
                                @click="unfriend(user)"
                                class="0 hover:text-indigo-500 flex py-2"
                            >
                            ...
                            <inertia-link
                                :href="'/profiles/' + user.id"
                                class=" hover:text-indigo-500 flex py-2"
                            >
