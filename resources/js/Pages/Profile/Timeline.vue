    ...
    <div :class="timelineClasses">
        <div class="md:w-4/12 w-0 invisible md:visible ">
            <div class="  w-9/12  ml-auto bg-white rounded-lg shadow ">
                <div
                    class=" text-center p-2 hover:bg-gray-50 hover:text-indigo-500 "
                >
                ...
                >
                    ...
                    <p>
                        {{ posts.length }} post<span class=" lowercase "
                            >(s)</span
                        >
                    </p>
                </div>
                ...
                >
                    ...
                    <p>
                        {{ countPictures }} picture<span class=" lowercase "
                            >(s)</span
                        >
                    </p>
                </div>
...
export default {
    ...
    methods: {
        ...
        getPosts() {
            axios
                .get(window.location.href.split("/").pop() + "/posts")
                .then(response => {
                    // console.table(response.data)
